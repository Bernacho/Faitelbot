...
Steps followed:
1. Extract Faitelson Tweets and their replies: [Notebook](./scraper/get_tweets.ipynb)
2. Perform Exploratory data analysis on the tweets and replies: [Notebook](./EDAV.ipynb)
3. Build a training set to train a LLM: [Notebook](./scraper/create_training_set.ipynb)
